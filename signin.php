...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['signin'])) {
    ...
    if ($username) {
        ...
        if ($role === 'creator') {
            ...
            echo "<script>alert('Login successful! Redirecting to video upload page.');header('http://'.$_SERVER['HTTP_HOST'].'/video.php');// window.location.href='http://reelsapp.azurewebsites.net/video.php';</script>";
             exit;
        } else {
